...
export default function Pets(){
    ...
    return (<div className="relative min-h-screen overflow-hidden bg-[#0a0a0f] bg-gradient-to-b from-[#0a0a0f] via-[#0f0d1a] to-[#0a0a0f] px-6 py-10">
        ...
        <style jsx global>{`
            ...
            .pets-blob-purple { animation: float1 10s ease-in-out infinite; }
            .pets-blob-green { animation: float2 12s ease-in-out infinite; }
            .pets-fade-up { animation: fadeInUp 0.6s ease-out forwards; }
        `}</style>

        {/* glows decorativos animados */}
        <div className="pets-blob-purple pointer-events-none absolute -top-40 -left-40 h-96 w-96 rounded-full bg-[#a855f7]/15 blur-[130px]" />
        <div className="pets-blob-green pointer-events-none absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-[#22c55e]/10 blur-[130px]" />

        <div className="pets-fade-up relative z-10 mx-auto mb-8 flex w-full max-w-5xl items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-3xl font-semibold tracking-tight text-white">
                    Gestão de <span className="bg-gradient-to-r from-[#a855f7] to-[#22c55e] bg-clip-text text-transparent">pets</span>
                </h1>
            </div>
        ...
        <div className="pets-fade-up relative z-10 mx-auto w-full max-w-5xl">
            ...
            <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_20px_50px_-15px_rgba(168,85,247,0.2)]">
                ...
                <table className="w-full text-left">
                    ...
                    <tbody>
                        ...
                        <tr key={pet.id} className="border-t border-white/5 transition-colors duration-200 hover:bg-white/[0.04]">
